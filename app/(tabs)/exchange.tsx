  ...
  return (
    <ThemedView style={styles.container}>
      ...
      <View style={styles.balances}>
        <ThemedText>Balances: </ThemedText>
        {Object.entries(user.balance).map(([currency, amount]) => (
          <ThemedText key={currency}>{currency}: {amount}</ThemedText>
        ))}
      </View>
      ...
      <View style={styles.orderForm}>
        ...
        <Pressable style={styles.orderButton} onPress={handleOrder}>
          <ThemedText>Place Order</ThemedText>
        </Pressable>
      </View>
        ...
        <ScrollView>
          {orders.map(order => (
            <View key={order.id} style={styles.orderItem}>
              <ThemedText>{order.pair} - {order.side.toUpperCase()}</ThemedText>
              <ThemedText>{order.amount} @ {order.price}</ThemedText>
